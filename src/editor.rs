            ...
            let (intro, entries): (&str, &[(&str, &str)]) = match style {
                ScriptStyle::Builder => (
                    ...
                    &[
                        ...
                        ("graph.palette(count)", "Get vivid hex colours with matching perceptual lightness and chroma; only hue varies. Assign them with color: colors[index]."),
                ...
                ScriptStyle::Generator => (
                    ...
                    &[
                        ...
                        ("N.palette(count)", "Get vivid hex colours with matching perceptual lightness and chroma; only hue varies. Assign them with color: colors[index]."),
