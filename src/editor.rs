            ...
            let (intro, entries): (&str, &[(&str, &str)]) = match style {
                ScriptStyle::Builder => (
                    ...
                    &[
                        ...
                        ("graph.palette(count)", "Get vivid hex colours in rainbow order, with matching perceptual lightness and chroma. Each count spans the full rainbow. Assign them with color: colors[index]."),
                ...
                ScriptStyle::Generator => (
                    ...
                    &[
                        ...
                        ("N.palette(count)", "Get vivid hex colours in rainbow order, with matching perceptual lightness and chroma. Each count spans the full rainbow. Assign them with color: colors[index]."),
